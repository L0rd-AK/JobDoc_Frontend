...
const UpdateJob = () => {
    ...
    // ======================================================================
    useEffect(()=>{
        setStartDate(new Date(machedJob.Job_Posting_Date));
        setEndDate(new Date(machedJob.Application_Deadline));
    },[machedJob.Job_Posting_Date,machedJob.Application_Deadline]);
    console.log(machedJob);
    // ======================================================================
    ...
    const UpdateJob=(e)=>{
        ...
        const updatedJob={Job_Title,Job_Type: selected_jobType,Company_Logo,Name,Salary_Range,Job_Applicants_Number,Job_Posting_Date: selected_Job_Posting_Date,Application_Deadline: selected_Application_Deadline,Job_Description};
            ...
            <namem action="#">
                ...
                <div className="grid gap-4 sm:grid-cols-2 sm:gap-6">
                    ...
                    <div className="w-full">
                        ...
                        <DatePicker ref={Job_Posting_Date} placeholderText={machedJob.Job_Posting_Date} name="postedDate" className="border-accent" selected={endDate} onChange={(date) => setEndDate(date)} />
                    </div>
                    <div className="w-full">
                        <label name="deadline" className="block mb-2 text-sm font-medium text-black">Job Deadline</label>
                        <DatePicker ref={Application_Deadline} placeholder={machedJob.Application_Deadline} name="deadline" selected={startDate} onChange={(date) => setStartDate(date)} />
                    </div>
