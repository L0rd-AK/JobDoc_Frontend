...
const JobDetail = () => {
    ...
    const AppliedJob={Company_Logo,Applied: true,Job_Applicants_Number:parseFloat(Job_Applicants_Number)+1,userEmail: user.email,Job_Title,Name,userName:user.displayName}
    const handelApply=()=>{
